	...
	<form>
		...
		<div class="row">
			...
			<div class="col-xs-2 col-sm-2 col-md-2">
				Minimum : <input id="minVal" type="number" min="0" max="10000" value=<?php echo '"'.$sensor_min[0].'"';?>>
				<br>
				Maximum : <input id="maxVal" type="number" min="0" max="10000" value=<?php echo '"'.$sensor_max[0].'"';?>>
			</div>
		</div>
		<br>
		<div class="row">
		...
		<div class="row">
			...
			<div class="col-xs-3 col-sm-3 col-md-3">
				...
				if(($infMax_associated == 1) || ($assoc == 0))
					echo '<input type="checkbox" id="infMax" value="on" checked > ';
				else
					echo '<input type="checkbox" id="infMax" value="on"> On/Off ';
				?>
				<br>
...
//
//			type: "GET",
//			url: "postSensorIBM.php",
//			data: {deviceId : <?php echo $sensor_serial[0] ?> }
//		});
		...
		$.ajax({
			...
			data: {deviceId : <?php echo $sensor_serial[0] ?>, typeId : <?php echo $typeId ?>, alertInf : alertInf, alertSup : alertSup, min: min, max:max, associated: <?php echo $timer_associated ?>, association: association, name: name, sensorId: <?php echo $sensor_id ?>, infMin: infmin, supMin : supmin, infMax : infmax, supMax : supmax , userId: <?php echo $database->select("user", "id", "email", $_SESSION['email'])[0]; ?> },
